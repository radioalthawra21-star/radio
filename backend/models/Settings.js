...
settingsSchema.statics.initializeDefaults = async function() {
  const defaults = [
    ...
    { key: 'leaveDeathSecondDegreeDays', value: 2, description: 'أيام الوفاة - الدرجة الثانية' },
    { key: 'leaveDeathThirdDegreeDays', value: 1, description: 'أيام الوفاة - الدرجة الثالثة' },
    { key: 'leaveHajjDays', value: 30, description: 'عدد أيام إجازة الحج' },
    { key: 'leaveDevelopmentHoursPerWeek', value: 6, description: 'ساعات الإجازة التطويرية أسبوعياً' },
    ...
    { key: 'workEndHour', value: 16, description: 'ساعة نهاية الدوام الرسمي' },
    { key: 'workEndMinute', value: 0, description: 'دقيقة نهاية الدوام الرسمي' },
    { key: 'dailyWorkHours', value: 7, description: 'عدد ساعات العمل اليومية' },
