...
export const payrollRoutes = (
  <>
    <Route path="/payroll" element={<ProtectedRoute allowedRoles={['admin', 'manager', 'hr']}><PW><PayrollDashboard /></PW></ProtectedRoute>} />
    <Route path="/payroll/management" element={<ProtectedRoute allowedRoles={['admin', 'manager', 'hr']}><PW><PayrollManagement /></PW></ProtectedRoute>} />
    ...
    <Route path="/payroll/processing" element={<ProtectedRoute allowedRoles={['admin', 'manager', 'hr']}><PW><PayrollProcessing /></PW></ProtectedRoute>} />
