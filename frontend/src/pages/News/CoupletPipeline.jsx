...
const STAGES = [
  ...
  { id: 6, name: 'التنسيق الرباعي الثنائي', desc: 'تقسيم النص إلى أسطر من 4 كلمات في ثنائيات' },
];

const CoupletPipeline = () => {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto" dir="rtl">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">تحرير الفيديو جراف</h1>
        <p className="text-gray-500 text-sm">تنسيق النصوص في أسطر من 4 كلمات مقسمة إلى ثنائيات - 6 مراحل تحريرية</p>
      </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-green-200 p-6 mt-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-green-600">بعد التنسيق الرباعي الثنائي</p>
                  </div>
                  <button
...
export default CoupletPipeline;
