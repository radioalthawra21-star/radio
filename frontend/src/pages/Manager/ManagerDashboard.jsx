                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        {req.type === 'annual' ? 'إدارية' : req.type === 'sick' ? 'مرضية' : req.type === 'exceptional' ? 'استثنائية' : req.type === 'death' ? 'وفاة' : req.type === 'hourly' ? 'ساعية' : req.type} · {req.type === 'hourly' ? `${req.hours} ساعات` : `${req.days} يوم`}
