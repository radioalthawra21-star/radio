...
const DailyReportsDashboard = () => {
  ...
  const fetchSummary = useCallback(async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await getAdminTodaySummary(selectedDate);
    ...
    <div className="p-3 md:p-6" dir="rtl">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">{formatDateArabic(selectedDate)}</p>
        </div>
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            <input
              ...
              className="p-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary"
            />
            {!isToday && (
              <button
                onClick={() => setSelectedDate(getTodayStr())}
                className="px-3 py-2.5 bg-primary/10 text-primary rounded-lg hover:bg-primary/20 transition-colors text-sm font-medium whitespace-nowrap"
              >
                اليوم
              </button>
            )}
          ...
          <button
            ...
            className="px-4 py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors text-sm flex items-center gap-2"
          >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <Card>
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-gray-500">لمقدموا</p>
              ...
              <Card>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                    <span className="text-sm text-gray-700">لمقدموا</span>
            ...
            <Card>
              <div className="flex items-center justify-between mb-4 border-b pb-2">
                <h2 className="text-lg font-semibold text-gray-800">
                  ...
                  {isToday ? 'تم التقديم اليوم' : 'تم التقديم'}
                </h2>
              ...
              {data.submittedUsers.length === 0 ? (
                <p className="text-gray-400 text-center py-4">لم يقم أي موظف بتقديم التقرير في هذا التاريخ</p>
              ) : (
            ...
            <Card>
              ...
              {data.notSubmittedUsers.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-green-600 font-medium">جميع الموظفين قدموا تقاريرهم!</p>
                </div>
              ) : (
                <div className="space-y-2 max-h-[400px] overflow-y-auto">
